...
\par Zauważalny jest także rozwój telefonów w kierunku fotografii. Nowsze modele posiadają znacznie większą liczbę megapikseli (czasem nawet dwukrotnie) niż lustrzanki wyprodukowane kilka lat po dwutysięcznym roku. Posiadają dodatkowo coraz więcej obiektywów zwielokrotniając kontrolę nad finalnym efektem zdjęcia.
