...
\begin{subfigure}{0.3\textwidth}
\centering
\includegraphics[width=0.9\linewidth, width=5cm]{friends4}
...
\begin{subfigure}{0.4\textwidth}
\centering
\includegraphics[width=0.9\linewidth, width=5cm]{recommendation1}
\caption{Powiadomienie aplikacji}
\label{fig:recommendation1}
\end{subfigure}
\begin{subfigure}{0.4\textwidth}
\centering
\includegraphics[width=0.9\linewidth, width=5cm]{recommendation2}
\caption{Lista miejsc wartych uwagi}
\label{fig:recommendation2}
\end{subfigure}
