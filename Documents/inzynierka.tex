...
\par Zauważalny jest także rozwój telefonów w kierunku fotografii. Nowsze modele posiadają znacznie większą (czasem nawet dwukrotnie) liczbę megapikseli  niż lustrzanki wyprodukowane kilka lat po dwutysięcznym roku. Posiadają dodatkowo coraz więcej obiektywów zwielokrotniając kontrolę nad finalnym efektem zdjęcia.
...
\par Zdecydowano się na implementację aplikacji dla systemu mobilnego Android, rozwijanego przez firmę Google. Opera się on na jądrze systemu operacyjnego Linux oraz na oprogramowaniu posiadającym licencję GNU ( \textit{GNU General Public License} ).
...
\addcontentsline{toc}{chapter}{Bibliografia}
  \bibitem{Here} Dokumentacja interfejsów programistycznych platformy HERE Maps, http://developer.here.com (dostęp: 01.05.2019 - 15.11.2019)
  
  \bibitem{gms.location} Dokumentacja interfejsu platformy Google API - biblioteka umożliwiająca lokalizację, https://developers.google.com/android/reference/com/google/android/gms/location/package-summary (dostęp: 10.10.2019)
  ...
  \bibitem{ContentProvider} Dokumentacja klasy ContentProvider, https://developer.android.com/reference/android/content/ContentProvider (dostęp: 07.08.2019)
  
  \bibitem {MatrixCursor} Dokumentacja klasy MatrixCursor, https://developer.android.com/reference/android/database/MatrixCursor (dostęp: 07.08.2019)
  
  \bibitem {SearchManager} Dokumentacja klasy SearchManager, https://developer.android.com/reference/android/app/SearchManager (dostęp: 07.08.2019)
  
  \bibitem {AlertDialog} https://developer.android.com/reference/android/app/AlertDialog.html
  
  \bibitem {Snackbar} https://developer.android.com/reference/android/support/design/widget/Snackbar
  
  \bibitem {LinearLayout} https://developer.android.com/guide/topics/ui/layout/linear
  
  \bibitem {SwipeRefreshLayout} Dokumentacja klasy SwipeRefreshLayout, https://developer.android.com/reference/android/support/v4/widget/SwipeRefreshLayout (dostęp: 28.08.2019)
  
  \bibitem {DialogFragment} https://developer.android.com/reference/android/app/DialogFragment
  
  \bibitem {PopupMenu} https://developer.android.com/reference/android/widget/PopupMenu
  
  \bibitem {Facebook} https://www.facebook.com/
  
  \bibitem {Intent} https://developer.android.com/reference/android/content/Intent
  ...
  \bibitem{JWT} Dokumentacja standardu JSON Web Token, https://tools.ietf.org/html/rfc7519 (dostęp: 10.09.2019)
  
  \bibitem{JWT library} Dokumentacja biblioteki JJWT, https://mvnrepository.com/artifact/io.jsonwebtoken/jjwt (dostęp: 10.09.2019)
  
  \bibitem{Retrofit library} Dokumentacja biblioteki Retrofit2, https://square.github.io/retrofit/ (dostęp: 01.09.2019)
  
  \bibitem{OkHttpClient} Dokumentacja klasy OkHttpClient, https://square.github.io/okhttp/ (dostęp: 01.09.2019)
  ...
  \bibitem{GoogleApi} Dokumentacja interfejsu wyszukiwania tras oferowana przez serwis Google, https://cloud.google.com/maps-platform/routes/ (dostęp: 23.10.2019)
  
  \bibitem{JsonParser} Dokumentacja klasy JsonParser umożiwiającej serializację i deserializację, https://static.javadoc.io/com.google.code.gson/gson/2.8.5/com/google/gson/JsonParser.html (dostęp: 30.09.2019)
  
  \bibitem{GsonBuilder} Dokumentacja klasy GsonBuilder, https://static.javadoc.io/com.google.code.gson/gson/2.8.0/com/google/gson/GsonBuilder.html (dostęp: 30.09.2019)
  
  \bibitem{escapeUtils} Dokumentacja klasy StringEscapeUtils, https://commons.apache.org/proper/commons-lang/apidocs/org/apache/commons/lang3\\/StringEscapeUtils.html (dostęp: 17.10.2019)
  ...
  \bibitem{PostgreSQL} https://www.postgresql.org/
  \bibitem{Neo4j} https://neo4j.com/
  \bibitem{JDBC} https://jdbc.postgresql.org/
  \bibitem{contextualActionMode} https://developer.android.com/guide/topics/ui/menus
