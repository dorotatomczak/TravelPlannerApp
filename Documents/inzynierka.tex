...
\addcontentsline{toc}{chapter}{Bibliografia}
  ...
  \bibitem {MatrixCursor} https://developer.android.com/reference/android/database/MatrixCursor
  \bibitem {SearchManager} https://developer.android.com/reference/android/app/SearchManager
  ...
  \bibitem {SwipeRefreshLayout} https://developer.android.com/reference/android/support/v4/widget/SwipeRefreshLayout
