...
\centering
\subfloat[Wyszukanie pobliskich kawiarni.\label{fig:TIsubim3}]{\includegraphics[width=0.4\textwidth]{tripit3}}\hfill
\subfloat[Udostępnianie planu podróży.\label{fig:TIsubim4}]{\includegraphics[width=0.4\textwidth]{tripit4}}\hfill
...
\centering
\subfloat[Tworzenie nowej podróży.\label{fig:GTsubim1}]{\includegraphics[width=0.4\textwidth]{googletrips1}}\hfill
\subfloat[Przeglądanie mapy z polecanymi obiektami.\label{fig:GTsubim2}]{\includegraphics[width=0.4\textwidth]{googletrips2}}\hfill
