...
\cline{2-4}
 & Średnia ocena & Liczba pobrań & Średnia ocena \\
\hline
...
\centering
\null\hfill
\subfloat[Tworzenie nowej podróży.\label{fig:GTsubim1}]{\includegraphics[width=0.4\textwidth]{googletrips1}}
\hfill
\subfloat[Przeglądanie mapy z polecanymi obiektami.\label{fig:GTsubim2}]{\includegraphics[width=0.4\textwidth]{googletrips2}}
\hfill\null
...
\centering
\null\hfill
\subfloat[Przeglądanie planu dnia.\label{fig:GTsubim3}]{\includegraphics[width=0.4\textwidth]{googletrips3}}\hfill
\subfloat[Przeglądanie informacji na temat regionalnej kuchni.\label{fig:GTsubim4}]{\includegraphics[width=0.4\textwidth]{googletrips4}}\hfill\null
...
\centering
\null\hfill
\subfloat[Tworzenie nowej podróży.\label{fig:STsubim1}]{\includegraphics[width=0.4\textwidth]{sygictravel1}}
\hfill
\subfloat[Menu główne.\label{fig:STsubim2}]{\includegraphics[width=0.4\textwidth]{sygictravel2}}
\hfill\null
...
\centering
\null\hfill
\subfloat[Menu główne.\label{fig:Esubim1}]{\includegraphics[width=0.4\textwidth]{expedia1}}
\hfill
\subfloat[Wyszukiwanie noclegu.\label{fig:Esubim2}]{\includegraphics[width=0.4\textwidth]{expedia2}}
\hfill\null
