...
class UpdatePlanElementException(override val message: String,
                              override val code: ResponseCode = ResponseCode.UPDATE_PLAN_ELEMENT_ERROR): Exception(message), ApiException
